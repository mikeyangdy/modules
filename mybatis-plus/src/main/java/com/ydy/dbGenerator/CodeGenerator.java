...
//官方网站： https://mp.baomidou.com/guide/generator.html
...
//        dataBaseParams.setPassword("root1234");
        ...
        dsc.setUrl("jdbc:mysql://"+dataBaseParams.getHost()+":"+dataBaseParams.getPort()
                +"/"+dataBaseParams.getDbName()+"?useUnicode=true&useSSL=false&characterEncoding=utf8");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setUsername(dataBaseParams.getUserName());
        dsc.setPassword(dataBaseParams.getPassword());
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setModuleName(scanner("模块名"));
        pc.setParent("com.ydy.modules");
